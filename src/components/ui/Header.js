...
export default function Header(props) {
  ...
  const routes = useMemo(() => {
    return [
      ...
      { name: "La Revolucion", link: "/revolution", activeIndex: 2 },
      { name: "Sobre Nosotros", link: "/about", activeIndex: 3 },
      { name: "Contáctanos", link: "/contact", activeIndex: 4 },
    ];
  }, [anchorEl]);
